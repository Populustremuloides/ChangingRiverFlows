...
def plotFuh():
    ...
    axs[1].set_ylabel("P - ET (Liters per Square Kilometer / Year)", fontsize=13)
    ...
    cbar = fig.colorbar(scatter, ax=axs[2], orientation="vertical")
    cbar.set_label("Forest Cover", fontsize=15)
    cbar.ax.tick_params(labelsize=12)
    #axs[2].set_title("Q (discharge)", fontsize=17)
    axs[2].set_xlabel("Catchment Area", fontsize=15)
    axs[2].set_ylabel("Q (Liters per Square Kilometer / Year)", fontsize=13)
